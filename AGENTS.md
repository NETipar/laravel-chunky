...
- Protocol and behavior documentation lives in `docs/` (`protocol.md`, `openapi.yaml`, `behavior-inventory.md`, `configuration.md`); update it when endpoint or event behavior changes.
